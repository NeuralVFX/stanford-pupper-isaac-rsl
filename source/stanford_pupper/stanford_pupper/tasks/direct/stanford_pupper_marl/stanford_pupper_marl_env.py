...
from .stanford_pupper_marl_env_cfg import StanfordPupperMarlEnvCfg


class StanfordPupperMarlEnv(DirectMARLEnv):
    cfg: StanfordPupperMarlEnvCfg

    def __init__(self, cfg: StanfordPupperMarlEnvCfg, render_mode: str | None = None, **kwargs):
